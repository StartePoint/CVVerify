...
class SegmentationOnnxStep : public IPipelineStep
{
public:
    SegmentationOnnxStep(DetectionModelDescriptor descriptor, QString modelPath, QStringList labels);
